      ...
      <CardContent className="p-4">
        <Tabs defaultValue="artists" className="w-full">
                ...
                <ScrollArea className="h-full pr-3">
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 p-4">
                    {topArtists.map((artist, index) => (
                      ...
                      >
                        <Badge className="absolute top-2 left-2 z-10 bg-black/60 text-white rounded-full w-6 h-6 p-0 flex items-center justify-center font-bold">
                          {index + 1}
                        </Badge>
          ...
          <TabsContent value="tracks" className="mt-0 space-y-6">
                  ...
                  <CardContent className="p-5">
                    <div className="flex">
                      <div className="relative min-w-[120px] h-[120px] mr-5">
                        ...
                        >
                          <Button className="bg-[#1ED760] hover:bg-[#1ED760]/90 rounded-full h-12 w-12 p-0">
                            <Play size={24} className="fill-black" />
                          </Button>
                        </div>
                        <Badge className="absolute top-0 left-0 bg-[#121212]/80 text-white border-none">
                          #{index + 1}
                        </Badge>
                      </div>
            ...
            {/* Track List Table */}
            <Card className="bg-[#121212] border-none overflow-hidden">
              <CardContent className="p-0">
                <Table>
                  <TableHeader className="bg-[#232323]">
                    <TableRow>
                      <TableHead className="w-[60px] text-[#B3B3B3]">
                        #
                      </TableHead>
